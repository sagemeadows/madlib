...
4. Keep them in {water=liquid} on the way home. If the {roses={rose=noun}+pl} are out of {water=liquid} even for {a few minutes=duration}, they'll suffer for it, and they won't stay {fresh=adj} as long. When you go to the {flower=noun} shop, you might want to bring along a bucket filled with a few inches of {water=liquid} so you'll have a place to keep the {roses={rose=noun}+pl} watered when you take them home. If you don't have a bucket, ask the {florist=person} to package them with {water=liquid}.
